class DropboxController {
    ...
    connectFirebase() {
        var firebaseConfig = {
            apiKey: "AIzaSyAM9lMc4-YjMdyfmdWs48oq70zSXHoOubk",
            authDomain: "dropbox-clone-b5275.firebaseapp.com",
            databaseURL: "https://dropbox-clone-b5275.firebaseio.com",
            projectId: "dropbox-clone-b5275",
            storageBucket: "dropbox-clone-b5275.appspot.com",
            messagingSenderId: "229412558016",
            appId: "1:229412558016:web:9bf03d779d4dcd48e20925",
            measurementId: "G-E0WSTDHDCC"
        };
    ...
    initEvents() {
        ...
        this.btnRename.addEventListener('click', e => {
            ...
            let name = prompt('Renomear aqruivo:', file.name);
        ...
        this.inputFilesEl.addEventListener('change', event => {
            ...
            this.uploadTask(event.target.files).then(responses => {
                //para arquivos no DB do firebase
    ...
    initEventsLi(li) {
        ...
        li.addEventListener('dblclick', e => {
            ...
            switch (file.type) {
                ...
                default:
                    //abrir do firebase storage
                    window.open(file.path);

                    //abrir direto do server 
